...
def run_benchmarks():
    ...
    for n in n_values:
        ...
        results.append([get_last_prime_rs.__name__, "Rust_lastprime", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(get_last_prime_numpy, {'limit':n}, name="Numpy_lastprime")
        results.append([get_last_prime_numpy.__name__, "Numpy_lastprime", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(get_last_prime_wo_rust, {'limit':n}, name="Python_lastprime")
        results.append([get_last_prime_wo_rust.__name__, "Python_lastprime", n, avg_time, avg_memory, out_len])

        # sum_primes variants
        avg_time, avg_memory, out_len = benchmark_function(sum_primes_rust, {'limit':n}, name="Rust_sumprimes")
        results.append([sum_primes_rust.__name__, "Rust_sumprimes", n, avg_time, avg_memory, out_len])
        ...
        results.append([sum_primes_rs_calling_in_python.__name__, "Rust_sumprimes_calling_in_python", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(sum_primes_numpy, {'limit':n}, name="Numpy_sumprimes")
        results.append([sum_primes_numpy.__name__, "Numpy_sumprimes", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(sum_primes_wo_rust, {'limit':n}, name="Python_sumprimes")
        results.append([sum_primes_wo_rust.__name__, "Python_sumprimes", n, avg_time, avg_memory, out_len])
        ...
        results.append([get_primes_rs.__name__, "Rust_return_array", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(get_last_prime_rs, {'limit':n}, name="Rust_return_number")
        results.append([get_last_prime_rs.__name__, "Rust_return_number", n, avg_time, avg_memory, out_len])

        # Multithread calc pi
        avg_time, avg_memory, out_len = benchmark_function(estimate_pi_rust, {'limit':n, 'threads':4}, name="Rust_estimate_pi")
        results.append([estimate_pi_rust.__name__, "Rust_estimate_pi", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(estimate_pi_rust, {'limit':n, 'threads':1}, name="Rust_estimate_pi_single_thread")
        results.append([estimate_pi_rust.__name__, "Rust_estimate_pi_single_thread", n, avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(estimate_pi_raw_multi_thread, {'limit':n}, name="Python_estimate_pi")
        results.append([estimate_pi_raw_multi_thread.__name__, "Python_estimate_pi", n, avg_time, avg_memory, out_len])
        ...
        results.append([estimate_pi_raw_single_thread.__name__, "Python_estimate_pi_single_thread", n, avg_time, avg_memory, out_len])
        ...
        results.append([estimate_pi_raw_multi_processing.__name__, "Python_estimate_pi_multi_processing", n, avg_time, avg_memory, out_len])
    ...
    for conv_size in convolve_values:
        ...
        results.append([fft_convolve_rust.__name__, "Rust_fft_convolve", conv_size[0], avg_time, avg_memory, out_len])

        avg_time, avg_memory, out_len = benchmark_function(fft_convolve_numpy, {'signal':sig,'kernel':filt}, name="Numpy_fft_convolve")
        results.append([fft_convolve_numpy.__name__, "Numpy_fft_convolve", conv_size[0], avg_time, avg_memory, out_len])
